...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Messenger\\AddProductToCart' => [0 => 'async'], 'App\\Messenger\\RemoveProductFromCart' => [0 => 'async'], 'App\\Messenger\\AddProductToCatalog' => [0 => 'async'], 'App\\Messenger\\RemoveProductFromCatalog' => [0 => 'async']], ($container->privates['.service_locator.NZdAz3P'] ?? $container->load('get_ServiceLocator_NZdAz3PService'))), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
